...
class SettingsPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        font_row_layout.addWidget(self.font_size)
        font_row_layout.addWidget(self.font_unit_label, 0, Qt.AlignmentFlag.AlignVCenter)
        font_row_layout.addStretch(1)
        self.font_size_row = font_row
        self.font_label = QLabel()
        appearance.addRow(self.font_label, font_row)
