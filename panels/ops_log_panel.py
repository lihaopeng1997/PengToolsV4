...
class ServerManageDialog(QDialog):
    ...
    def __init__(self, language='zh', servers=None, categories=None, parent=None):
        ...
        self.test_btn.clicked.connect(self._test)
        self.del_btn = QPushButton('删除' if zh else 'Delete')
        apply_button(self.del_btn, 'danger', compact=True, icon='delete', icon_size=16)
        self.del_btn.clicked.connect(self._delete)
...
class OpsLogPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        mode_row.addWidget(self.mode_session_btn)
        mode_row.addWidget(self.mode_export_btn)
        ...
        apply_button(self.path_refresh_btn, 'ghost', compact=True, icon='refresh', icon_size=16)
        ...
        apply_button(self.open_dir_btn, 'secondary', compact=True, icon='folder-open', icon_size=16)
