...
a = Analysis(
    ...
    hiddenimports=['docx', 'openpyxl', 'xlrd', 'xlwt', 'xlutils', 'msoffcrypto', 'PyQt6.QtSvg', 'websocket', 'websocket._app', 'mitmproxy', 'mitmproxy.tools.dump', 'mitmproxy.certs', 'mitmproxy.options', 'paramiko', 'cryptography', 'nacl'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
