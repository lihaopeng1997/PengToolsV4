...
# theme_id → 中英文名 + 副说明
THEME_META = {
    'calm': ('静谧办公', 'Calm Office', '石墨鼠尾草的沉静工作台', 'Graphite sage workbench'),
...
THEMES: dict[str, dict[str, str]] = {
    'calm': _with_extra({
        ...
        'ICON_MUTED': '#6B746E',
        'NAV_HOVER': '#EEEDE6',
        'NAV_ACTIVE_BG': '#E4EFE8',
        'STATUS_BAR_BG': '#F7F6F1',
        'TABLE_ALT': '#F6F5F0',
        'TABLE_SELECT': '#E4EFE8',
        'INPUT_BG': '#FFFEFB',
        'DISABLED_BG': '#EEEDE7',
        'DISABLED_TEXT': '#A3AAA5',
        'DISABLED_ICON': '#858E88',
        'SHADOW': 'rgba(26, 31, 28, 36)',
        'BRAND_ICON_BG': '#E4EFE8',
        'USER_CHIP_BG': '#E4EFE8',
        'USER_CHIP_TEXT': '#2F5342',
        'SCROLL_HANDLE': '#C4C1B8',
    }, {
        'CODE_BG': '#F1F2EE',
        'ELEVATED_SURFACE': '#FFFEFB',
        'MONTH_HEADER_BG': '#E8EEE9',
        'MONTH_HEADER_FG': '#1A1F1C',
        'FOCUS_RING': '#3F6B56',
        'TERM_BG': '#101A16',
        'TERM_FG': '#E7F0EA',
        'TERM_MUTED': '#8AA396',
