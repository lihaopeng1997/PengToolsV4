...
_LIGHT_EXTRA = {
    ...
    'SIDEBAR_TEXT': '#1B1E2A',
    'SIDEBAR_TEXT_MUTED': '#6E7486',
    'SIDEBAR_HIGHLIGHT': 'rgba(0, 0, 0, 0.04)',
    'NAV_ACTIVE_TEXT': '#FFFFFF',
    'ACCENT_INDIGO': '#5B73FF',
    'ACCENT_CYAN': '#0EA5E9',
    'ACCENT_ROSE': '#EC4899',
...
THEMES: dict[str, dict[str, str]] = {
    'calm': _with_extra({
        'APP_BG': '#E8ECF5',
        'SIDEBAR_BG': '#161D30',
        'SIDEBAR_BORDER': '#242E47',
        'SIDEBAR_TEXT': '#F7F9FF',
        'SIDEBAR_TEXT_MUTED': '#8B97B3',
        'SIDEBAR_HIGHLIGHT': 'rgba(255, 255, 255, 0.08)',
        'SURFACE': '#FFFFFF',
        'SURFACE_SOFT': '#F0F3F9',
        'SURFACE_TECH': '#E6EBF5',
        'TEXT_STRONG': '#1B1E2A',
        ...
        'PRIMARY': '#4A61F0',
        'PRIMARY_HOVER': '#3D52D8',
        'PRIMARY_SOFT': '#ECEEFA',
        'PRIMARY_ACTIVE': '#3346C8',
        'CYAN': '#0EA5E9',
        'SUCCESS': '#2F7D52',
        'WARNING': '#B0722E',
        'DANGER': '#C04A54',
        ...
        'NAV_ACTIVE_BG': 'rgba(91, 115, 255, 0.35)',
        'NAV_ACTIVE_TEXT': '#FFFFFF',
        ...
        'USER_CHIP_BG': '#ECEEFA',
        'USER_CHIP_TEXT': '#3346C8',
        'SCROLL_HANDLE': '#C2C6D4',
        'PRIMARY_GRAD_START': '#5B73FF',
        'PRIMARY_GRAD_END': '#4A61F0',
    ...
    'black': {
        ...
        'AURORA_END': '#A8CDB4',
        'SIDEBAR_TEXT': '#F4F4F5',
        'SIDEBAR_TEXT_MUTED': '#8A8A90',
        'SIDEBAR_HIGHLIGHT': 'rgba(255, 255, 255, 0.05)',
        'NAV_ACTIVE_TEXT': '#FFFFFF',
        'ACCENT_INDIGO': '#8F94E0',
        'ACCENT_CYAN': '#7AC4CF',
        'ACCENT_ROSE': '#D97D8A',
        'ACCENT_EMERALD': '#8FBB9E',
    },
}
