...
class UiRegressionTests(unittest.TestCase):
    ...
    def test_floating_preview_shows_document_and_vin_keys(self):
        ...
        self.assertEqual(panel.preview_table.item(0, 2).text(), 'TZ180XSA000001')
        panel._copy_preview_item(panel.preview_table.item(0, 2))
        self.assertEqual(QApplication.clipboard().text(), 'TZ180XSA000001')
        panel.close()
